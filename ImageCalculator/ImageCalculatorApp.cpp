...
int main(int argc, char* argv[])
{
    ...
    CImageCalculator ImageCalculator;

    ERMsg msg = ImageCalculator.m_options.ParseOption(argc, argv);

    if (!ImageCalculator.m_options.m_bQuiet)
        cout << ImageCalculator.GetDescription() << endl;


    if (msg)
        msg = ImageCalculator.Execute();
